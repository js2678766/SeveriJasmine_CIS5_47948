...
void count(int[]); //Countdown to exit function
...
int main()
{
    ...
    int Size = 3; //For the count down array
    ...
    int pass[SIZE]; //Password Array. Parallel array
    int Pass[SIZE]; //To test the password. Parallel array
    int cntdwn[Size]; //Countdown to end game
...
{
    cout<<"\nI will spare your life for now. Next time, you may not be so lucky.\n"; 
    cout<<"[You played "<<round<<" rounds total.]\n";
